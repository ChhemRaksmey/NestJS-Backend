...
@Controller('/aml/sanction/risk-level')
export class SanctionRiskLevelController {

  private path_view  = "web/aml/sanction/risk-countries/";
  private path_route = "/aml/sanction/risk-level";
  private page_title = "Sanction Risk Level";
