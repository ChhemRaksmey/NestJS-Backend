...
@Controller('/aml/sanction/risk-countries')
export class SanctionRiskContriesController {

  private path_view  = "web/aml/sanction/risk-countries/";
  private path_route = "/aml/sanction/risk-countries";
  private page_title = "Sanction Risk Countries";
