...
@Controller('/aml/sanction/resources/oversea')
export class SanctionResourceOverseaController {

  private path_view  = "web/aml/sanction/resources/oversea/";
  private path_route = "/aml/sanction/resources/oversea";
  private page_title = "Sanction Resources Oversea";
